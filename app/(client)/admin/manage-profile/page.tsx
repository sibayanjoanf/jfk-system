...
import { CircleUserRound, Camera, Trash2, LogOut, Shield, Eye, EyeOff, ChevronRight } from 'lucide-react';
...
const ProfilePage: React.FC = () => {
  ...
  const getPasswordStrength = (password: string) => {
    ...
    if (password.length < 8) return { label: 'Fair', color: 'bg-orange-400', width: '50%' };
    if (!/[A-Z]/.test(password) || !/[0-9]/.test(password)) return { label: 'Good', color: 'bg-yellow-400', width: '75%' };
            ...
            <div className="relative mb-4">
              <div className="w-20 h-20 rounded-full bg-gray-100 overflow-hidden">
                <div className="w-full h-full flex items-center justify-center bg-gray-100/50">
                  <CircleUserRound size={40} className="text-gray-400" strokeWidth={1} />
                </div>
              </div>
            </div>
            <p className="text-sm font-semibold text-gray-900">{profileForm.firstName} {profileForm.lastName}</p>
          ...
          {activeTab === 'profile' && (
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              <div className="mb-6">
                ...
                <p className="text-xs text-gray-400 mt-1">Update your personal details and contact information.</p>
              </div>
          ...
          {activeTab === 'security' && (
                      ...
                      <div className="mt-2">
                        <div className="flex justify-between items-center mb-1">
                          ...
                          <span className={`text-xs font-medium ${
                            ...
                            strength.label === 'Fair' ? 'text-orange-400' : 'text-red-500'
                          }`}>{strength.label}</span>
                        </div>
            ...
            {/* Change Email */}
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">Update the email address associated with your account.</p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1.5">Confirm New Email</label>
                    <input
                        type="email"
                ...
                <div className="flex items-start gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-1 leading-relaxed">
                      Permanently delete your account and all associated data. This action is irreversible and cannot be undone. All your data will be permanently removed from our servers.
                    </p>
                  </div>
                </div>

                <div className="p-3 bg-red-50 rounded-lg border border-red-100 mb-5">
                  <p className="text-xs text-red-600 font-medium">⚠ Warning: This will permanently delete all your data, orders, and account information.</p>
                </div>
