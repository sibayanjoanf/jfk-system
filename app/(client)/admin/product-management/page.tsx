...
const ProductManagement: React.FC = () => {
  ...
  // Sub-categories shown in dropdown: scoped to selected category
  ...
  // Changing category resets sub-category
  // Single router.replace — avoids race condition from two separate URL writes
              ...
              <tbody className="divide-y divide-gray-50">
                {paginatedProducts.map((product) => (
                  ...
                  >
                    ...
                    {/* Product name with category below */}
