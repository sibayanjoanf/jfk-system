...
import { Calendar, Search, Bell, CircleUserRound, Trash2, ChevronDown, User, Settings, LogOut } from 'lucide-react';
...
const OrderManagement: React.FC = () => {
  ...
  const orders: Order[] = [
    { id: '1', customerName: 'Aliyah Segovia', customerEmail: 'asegovia@gmail.com', orderId: 'EL-00552', product: 'Product', date: '28 Sep, 2025', status: 'Pending', revenue: 3500, itemCount: 2 },
    { id: '2', customerName: 'Maverick Verdida', customerEmail: 'mverdida@gmail.com', orderId: 'EL-00551', product: 'Product', date: '28 Sep, 2025', status: 'Paid', revenue: 20000, itemCount: 5 },
    { id: '3', customerName: 'Russell Palcoto', customerEmail: 'rpalcoto@gmail.com', orderId: 'EL-00550', product: 'Product', date: '28 Sep, 2025', status: 'Processing', revenue: 500, itemCount: 1 },
    { id: '4', customerName: 'Rose Pajarito', customerEmail: 'rpajarito@gmail.com', orderId: 'EL-00549', product: 'Product', date: '28 Sep, 2025', status: 'Pending', revenue: 3070, itemCount: 3 },
    { id: '5', customerName: 'Venelyn Cordova', customerEmail: 'vcordova@gmail.com', orderId: 'EL-00548', product: 'Product', date: '28 Sep, 2025', status: 'Refunded', revenue: 23500, itemCount: 8 },
    { id: '6', customerName: 'Joan Sibayan', customerEmail: 'jsibayan@gmail.com', orderId: 'EL-00547', product: 'Product', date: '28 Sep, 2025', status: 'Paid', revenue: 7000, itemCount: 4 },
    { id: '7', customerName: 'Lindsay Mahusay', customerEmail: 'lmahusay@gmail.com', orderId: 'EL-00546', product: 'Product', date: '28 Sep, 2025', status: 'Completed', revenue: 10030, itemCount: 6 },
  ];
  ...
  const getDotColor = (status: string) => {
    switch (status) {
      case 'Paid': return 'bg-[#B427D0]';
      case 'Pending': return 'bg-[#FF8E29]';
      case 'Completed': return 'bg-[#27D095]';
      case 'Processing': return 'bg-[#20B2DF]';
      case 'Refunded': return 'bg-[#DF2025]';
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-6">
          <div>
            ...
            <p className="text-gray-400 text-xs mt-1 leading-relaxed">
              All orders placed by customers are listed below.<br />
            ...
            <tbody className="divide-y divide-gray-50">
              {filteredOrders.map((order) => (
                ...
                >
                  ...
                  <td className="py-3.5 px-4 text-sm font-medium text-gray-700">{order.orderId}</td>
                  <td className="py-3.5 px-4 text-sm text-gray-500 whitespace-nowrap">{order.date}</td>
                  ...
                  <td className="py-3.5 px-4 text-sm text-gray-500 text-center">{order.itemCount}</td>
                  <td className="py-3.5 px-4 text-sm text-gray-700 font-medium text-center">₱{order.revenue.toLocaleString()}</td>
