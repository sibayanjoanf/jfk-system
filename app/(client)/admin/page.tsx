...
const Dashboard: React.FC = () => {
  ...
  const statusData: StatusItem[] = [
    { name: "Pending", value: 43, color: "#FF8E29" },
    { name: "Processing", value: 27, color: "#20B2DF" },
    { name: "Paid", value: 16, color: "#4BD278" },
    { name: "Completed", value: 33, color: "#DF2025" },
  ];
  ...
  const customerData: CustomerItem[] = [
    ...
    { name: "Mingyu Kim", location: "Rizal" },
  ];

  const branchData: BranchItem[] = [
    { name: "Barit", value: 40, color: "#FF8E29" },
    { name: "Rizal", value: 30, color: "#4BD278" },
    ...
    <div className="p-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
        <MetricCard
          ...
          icon={ShoppingCart}
          showView={true}
          viewPath="admin/order-management"
        />
        <MetricCard
        ...
        <MetricCard
          ...
          icon={AlertTriangle}
          showView={true}
          viewPath="admin/inventory-management"
        />
        <MetricCard
          title="Revenue"
          value="35k"
