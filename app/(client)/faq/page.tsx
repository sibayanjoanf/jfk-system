        ...
        <section className="bg-[#f8f8f8] py-10 lg:py-15 text-sm">
          <div className="container mx-auto px-4">
            ...
            <div className="lg:hidden mb-8">
              <p className="font-semibold mb-4 uppercase tracking-wider text-gray-500">
                Categories
              </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-start">
              ...
              <div className="hidden lg:block lg:col-span-1">
                <p className="font-semibold uppercase tracking-widest text-sm text-gray-400 mb-5">
                  Categories
                </p>
                ...
                {activeCategory ? (
                  ...
                  >
                    <Accordion
                      ...
                      className="w-full"
                      defaultValue={
                        activeCategory.faq[0] ? [activeCategory.faq[0].id] : []
                      }
                    >
