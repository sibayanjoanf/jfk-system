            ...
            <div className="flex flex-col lg:flex-row gap-15 items-start">
              ...
              <div className="w-full lg:w-72 lg:sticky lg:top-30">
                <div className="border rounded-xl p-6 bg-white shadow-sm space-y-4">
                  <h2 className="text-sm font-semibold uppercase tracking-widest text-gray-400">Order Summary</h2>
                  ...
                  <p className="text-xs text-gray-400">Please proceed to the inquiry form to continue.</p>
