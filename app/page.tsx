    ...
    <Link href={`/collection/${categoryLabel.toLowerCase()}`}>
      <div className="aspect-4/2 md:aspect-square group relative overflow-hidden rounded-lg bg-gray-100 cursor-pointer">
        ...
        <div className="absolute flex inset-0 items-center justify-center lg:opacity-0 transition-all duration-300 lg:translate-y-4 group-hover:opacity-100 group-hover:translate-y-0">
          <span className="text-[#f8f8f8] text-2xl md:text-3xl font-bold text-shadow-lg">
            {categoryLabel}
          </span>
        </div>
      </div>
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="flex justify-end">
                  <Link
                    href="/about"
                    className="relative inline-flex items-center text-sm font-medium px-4 py-2 rounded-md text-red-600 group overflow-hidden"
                  >
                    <span className="absolute inset-0 bg-red-600 translate-x-[-100%] group-hover:translate-x-0 transition-transform duration-300 ease-in-out rounded-md"></span>
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
              <div className="flex flex-col justify-center order-2 lg:order-1">
                ...
                <div className="flex justify-end">
                  <Link
                    href="/faq"
                    className="relative inline-flex items-center text-sm font-medium px-4 py-2 rounded-md text-red-600 overflow-hidden group"
                  >
                    <span className="absolute inset-0 bg-red-600 translate-x-[-100%] group-hover:translate-x-0 transition-transform duration-300 ease-in-out rounded-md" />
                    <span className="relative z-10 group-hover:text-white transition-colors duration-300 flex items-center">
