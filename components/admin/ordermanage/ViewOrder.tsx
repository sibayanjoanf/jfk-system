    ...
    <div className="p-0">
      ...
      <div className="bg-white rounded-3xl border border-[#E1E1E1] shadow-sm p-8">
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            <h2 className="text-xl font-semibold text-[#050F24]">
              Order Details
            </h2>
            <div className="mt-4">
              <table className="text-sm border-separate border-spacing-y-2">
                <tbody>
                  <tr>
                    <td className="text-[#6F757E] font-normal pr-8">
                      Order ID:
                    </td>
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="p-2 text-[#DF2025] hover:bg-red-50 rounded-lg">
              <Printer size={20} />
            </button>
            <button className="p-2 text-[#DF2025] hover:bg-red-50 rounded-lg">
              <Download size={20} />
        ...
        <div className="mx-auto bg-[#DF2025] rounded-2xl p-12 px-[6%] mb-[-60px] w-[95%] relative z-10 flex justify-between items-start text-white overflow-hidden">
          ...
          {progress.map((step, idx) => (
            <div
              key={idx}
              className="relative z-20 flex flex-col items-center text-center w-24"
            >
              <div
                className={`w-4 h-4 rounded-full mb-4 z-30 transition-all duration-500 ${
                  step.active ? "bg-white" : "bg-[#e55357]"
                }`}
              />

              <div
                className={`transition-opacity duration-500 ${step.active ? "opacity-100" : "opacity-50"}`}
              >
        ...
        <div className="bg-white rounded-3xl border border-gray-200 shadow-sm p-8 pt-20 pb-3">
          {/* Billing Info */}
          <h3 className="text-lg font-semibold text-[#050F24] mb-4">
            Billing Information
          </h3>
          <div className="bg-white rounded-3xl p-6 border border-gray-200 shadow-sm relative mb-8">
            <button className="absolute top-6 right-6 text-[#CCCDCD]">
              <Info size={18} />
            </button>
            <div className="space-y-3">
              <p className="text-lg font-semibold text-[#050F24]">
                Jennie Rubyjane Katigbak
              </p>
              <table className="w-full text-sm border-separate border-spacing-y-2">
                <tbody>
                  <tr>
                    <td className="text-[#6F757E] w-40 font-normal align-top">
                      Email Address :
                    </td>
                    <td className="text-[#050F24] font-normal pl-1">
                      jennierubyjane@gmail.com
                    </td>
                  </tr>
                  <tr>
                    <td className="text-[#6F757E] font-normal align-top">
                      Contact Number :
                    </td>
                    <td className="text-[#050F24] font-normal pl-1">
                      09127296749
                  ...
                  <tr>
                    ...
                    <td className="text-[#050F24] font-normal pl-1 leading-relaxed">
                      1235 Juan Luna Street, Barangay 129, Tondo, Manila, 1012,
                      Philippines
                    </td>
                  </tr>
                  <tr>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="text-[#050F24] font-semibold border-b border-gray-100">
                  <th className="pb-4 pl-8 font-semibold text-left w-[30%]">
                    Product
                  </th>
                  <th className="pb-4 px-4 font-semibold text-center w-[25%]">
                    ID No.
                  </th>
                  <th className="pb-4 px-4 font-semibold text-center w-[35%]">
                    Quantity
                  </th>
                  <th className="pb-4 pr-8 font-semibold text-center w-[10%]">
                    Price
                  </th>
                </tr>
              </thead>
                ...
                {[1, 2, 3].map((item) => (
                  <tr key={item}>
                    <td className="pl-8 py-4 flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-normal text-[#050F24]">
                          Product Name
                        </p>
                        <p className="text-xs font-normal text-[#6F757E]">
                          Product Type
                        </p>
                      </div>
                    </td>
                    <td className="px-4 py-4 font-normal text-center text-[#6F757E]">
                      EL-00552
                    </td>
                    <td className="px-4 py-4 font-normal text-center text-[#6F757E]">
                      1500
                    </td>
                    <td className="pr-8 py-4 font-normal text-center text-[#6F757E]">
                      ₱130
                    </td>
                  </tr>
                ))}
            ...
            <div className="flex flex-col">
              ...
              <div className="bg-white p-6 border border-gray-200 rounded-3xl shadow-sm relative flex-grow">
                ...
                <div className="space-y-1">
                  <p className="text-[20px] text-[#050F24] font-medium">
                    Master Card
                  </p>
                  <p className="text-[15px] text-[#6F757E] font-normal">
                    Master 1234 **** 58745
                  </p>
                  <p className="text-[10px] text-[#6F757E] font-normal">
                    Expire 12/23
                  </p>
              ...
              <div className="bg-white p-6 border border-gray-200 rounded-3xl shadow-sm flex-grow">
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between pt-4 border-t border-gray-50">
                    <span className="font-medium text-[20px] text-[#050F24]">
                      Total :
                    </span>
                    <span className="font-medium text-[20px] text-[#050F24]">
                      ₱3250
