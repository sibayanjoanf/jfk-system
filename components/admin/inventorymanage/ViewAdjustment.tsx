            ...
            <tbody>
              {adjustments.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50 transition">
                  ...
                  <td className="text-center text-gray-400">{item.type}</td>

                  <td className="text-center text-gray-400">{item.quantity}</td>

                  <td className="text-center text-gray-400">{item.batchId}</td>

                  <td className="text-center text-gray-400">{item.before}</td>

                  <td className="text-center text-gray-400">{item.after}</td>
                </tr>
              ))}
            </tbody>
          </table>
