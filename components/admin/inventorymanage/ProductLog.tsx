...
const ProductLog: React.FC = () => {
  ...
  const batches = [
    { id: 1, batchId: "LOT-2025-JAN-001", inbound: "Jan 15, 2025", initial: 100, remaining: 0, status: "Depleted" },
    { id: 2, batchId: "LOT-2025-FEB-002", inbound: "Feb 20, 2025", initial: 150, remaining: 0, status: "Depleted" },
    { id: 3, batchId: "LOT-2025-MAR-003", inbound: "Mar 25, 2025", initial: 80, remaining: 0, status: "Depleted" },
    { id: 4, batchId: "LOT-2025-APR-004", inbound: "Apr 01, 2025", initial: 125, remaining: 80, status: "In Use" },
    { id: 5, batchId: "LOT-2025-MAY-005", inbound: "May 10, 2025", initial: 90, remaining: 90, status: "Future" },
    { id: 6, batchId: "LOT-2025-JUN-006", inbound: "Jun 12, 2025", initial: 105, remaining: 105, status: "Future" },
    { id: 7, batchId: "LOT-2025-JLU-007", inbound: "Jul 18, 2025", initial: 55, remaining: 55, status: "Future" },
    { id: 8, batchId: "LOT-2025-AUG-008", inbound: "Aug 19, 2025", initial: 80, remaining: 80, status: "Future" },
    { id: 9, batchId: "LOT-2025-SEP-009", inbound: "Sep 05, 2025", initial: 60, remaining: 60, status: "Future" },
  ];
  ...
  return (
    <div className="p-0">
      ...
      <div className="flex gap-6 mt-6">
        <MetricCard title="Total Products" value="287" color="bg-green-500" icon={BookMarked} date="Oct 2025" showView viewPath="/products" />
        <MetricCard title="Low Stock Items" value="25" color="bg-orange-500" icon={AlertTriangle} date="Oct 2025" showView={false} />
        <MetricCard title="Out of Stock Items" value="38" color="bg-red-500" icon={CircleSlash2} date="Oct 2025" showView={false} />
      </div>
      ...
      <div className="mt-8 bg-[#FFFFFF] rounded-2xl p-6 border border-gray-200">
        <div className="flex justify-between items-start mb-6">
          ...
          <div>
            <h2 className="text-lg font-semibold text-[#0F172A]">Stock Activity Log</h2>
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => router.push(`/inventory/${id}/batch-consumption`)}
            className="flex items-center gap-2 bg-[#DF2025] text-white px-4 py-2 rounded-2xl font-semibold hover:bg-[#b3191d] transition-colors">
              Batch Consumption
            </button>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <tbody>
              {batches.map((batch) => (
                <tr key={batch.id} className="hover:bg-gray-50 transition">
                  <td className="py-4 px-6 font-medium text-[#0F172A]">{batch.batchId}</td>
                  <td className="text-gray-400 text-center">{batch.inbound}</td>
                  <td className="text-gray-400 text-center">{batch.initial}</td>
                  <td className="text-gray-400 text-center">{batch.remaining}</td>
          ...
          <div className="flex justify-between items-center px-6 py-4 border-t border-gray-200 text-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="w-8 h-8 rounded-full bg-[#DF2025] text-white flex items-center justify-center text-xs">1</button>
              <button className="w-8 h-8 rounded-full bg-gray-100 text-[#DF2025] text-xs hover:bg-[#DF2025] hover:text-white transition-colors duration-200">2</button>
